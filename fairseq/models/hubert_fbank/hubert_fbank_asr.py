...
@dataclass
class HubertFbankAsrConfig(FairseqDataclass):
...
@dataclass
class HubertFbankCtcConfig(HubertFbankAsrConfig):
    autoregressive: bool = False
    pass


@register_model("hubert_fbank_ctc", dataclass=HubertFbankCtcConfig)
class HubertFbankCtc(BaseFairseqModel):
    def __init__(self, cfg: HubertFbankCtcConfig, w2v_encoder: BaseFairseqModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: HubertFbankCtcConfig, task: FairseqTask):
        """Build a new model instance."""
        w2v_encoder = HubertFbankEncoder(cfg, task)
...
@dataclass
class HubertFbankSeq2SeqConfig(HubertFbankAsrConfig):
...
@register_model("hubert_fbank_seq2seq", dataclass=HubertFbankSeq2SeqConfig)
class HubertFbankSeq2SeqModel(FairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)

    @classmethod
    def build_model(cls, cfg: HubertFbankSeq2SeqConfig, task: FairseqTask):
        """Build a new model instance."""
        ...
        model = HubertFbankSeq2SeqModel(encoder, decoder)
    ...
    @classmethod
    def build_encoder(cls, cfg: HubertFbankAsrConfig, task):
        return HubertFbankEncoder(cfg, task)

    @classmethod
    def build_decoder(cls, cfg: HubertFbankSeq2SeqConfig, tgt_dict, embed_tokens):
...
class HubertFbankEncoder(FairseqEncoder):
    def __init__(self, cfg: HubertFbankAsrConfig, task):
...
class SuperbFeaturlizer(nn.Module):
    def __init__(self, cfg: HubertFbankAsrConfig):
        super().__init__()
